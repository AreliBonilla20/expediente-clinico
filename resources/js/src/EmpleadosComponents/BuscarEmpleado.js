...
const BuscarEmpleado = () => {
    ...
    useEffect(() => {
        API.empleado_buscar(param_busqueda).then(res => {
                    ...
                    <section className="section">
                        <div className="card">
                            <div className="card-header">
                                <Link to="/empleados" className="btn btn-secondary"><i className="bi bi-arrow-left"></i> Regresar </Link>
                            </div>
