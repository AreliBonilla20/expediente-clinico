...
const AsignarCirugia = () => {
    ...
    useEffect(() => {
        API.asignar_cirugia_datos_formulario(id_consulta, id_hospitalizacion).then(res => {
           const result = res.data;
           set_quirofanos(result.quirofanos);
           set_cirugias(result.cirugias)
       })
    ...
    const asignarCirugia = async (data) => {
        try {
          const body = { codigo_cirugia, id_quirofano, hora_cirugia };
          const response = await fetch(`${API_URL}/historial_cirugias/${id_consulta}/${id_hospitalizacion}/guardar`, {
            method: "POST",
                            ...
                            <div className="card">
                                ...
                                <div className="card-content">
                                    <div className="card-body">
                                        <form className="form form-vertical" onSubmit={handleSubmit(asignarCirugia)}>
