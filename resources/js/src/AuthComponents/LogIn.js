...
export default class LogIn extends Component{
    ...
    onSignIn(event){
        ...
        let response=fetch(`./api/login`,{
            ...
            let permissions = JSON.parse(atob(json.token.split('.')[1])).permission;
                    ...
                    <div className="col-lg-5 col-12">
                        <div id="auth-left">
                            ...
                            <div className="text-center mt-5 text-lg fs-4">
                                <p className="text-gray-600">¿No tienes una cuenta? <a href="auth-register.html" className="font-bold">Registrarse</a>.</p>
