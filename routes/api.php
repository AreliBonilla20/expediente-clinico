...
*/
    ...
    Route::group([ 'middleware' => ['api']], function () {
        ...
        Route::put('/historial_diagnosticos/{codigo_diagnostico}/actualizar', 'HistorialDiagnosticosController@update');
        ...
        //Rutas para el historial de examenes del paciente
        Route::get('/historial_cirugias/{id_consulta}/{id_hospitalizacion}', 'HistorialCirugiasController@index');
        Route::get('/historial_cirugias/{id_consulta}/{id_hospitalizacion}/crear', 'HistorialCirugiasController@create');
        Route::post('/historial_cirugias/{id_consulta}/{id_hospitalizacion}/guardar', 'HistorialCirugiasController@store');
        ...
        Route::get('/cirugias/{param_busqueda}/buscar', 'CirugiaController@buscar');
